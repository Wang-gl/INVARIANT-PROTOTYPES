...
class Parser:
    ...
    def __init__(self):
        ...
        parser.add_argument('--config', default='config/emlip/EMLIP_EMA,tiny,m2000mbs64sbs10.yaml', help="Path to the configuration file for the training to launch.")
        #config/emlip/EMLIP_EMA,cifar10,m200mbs64sbs10.yaml   config/icml24/all/ERACE_EMA,cifar10,m200mbs64sbs10.yaml
        # Training parameters
        ...
        # Dataset parameters
        #####################
        parser.add_argument('--data-root-dir', default='E:/demo_new/emlip_ema-main/data/torchvision/',
        ...
        parser.add_argument('--dataset', '-d', default="tiny",
        ...
        parser.add_argument('--n-runs', type=int, default=5,help="Number of runs, with different seeds each time.")
        parser.add_argument('--start-seed', type=int, default=1, help="First seed to use.")
        ...
        ####emlip###########
        parser.add_argument('--emlip-alpha1', type=float, default=1.0)
        parser.add_argument('--emlip-alpha2', type=float, default=0.04)
        self.parser = parser
